...
export const getTags = (t) => ([
  t('hr-management-system'),
  t('okr-management-application'),
  t('crm-solution'),
  t('rpa-dros'),
  t('dinco-e&c'),
  t('accounting'),
...
export const _descriptions = [
  ...
  `Elevating HRM through a custom software solution for Dufago. Our development is now complete, refining processes and bringing forth heightened efficiency`,
  ...
  `This case study highlights our efficient Project Management software for Dinco E&C. Demonstrating adept oversight, we successfully met budget and timeline goals.`,
