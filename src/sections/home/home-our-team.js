...
export default function HomeOurTeam({ members }) {
  const theme = useTheme();
  const t = useTranslations('Homepage.our_team');
  const mdUp = useResponsive('up', 'md');
  const tComon = useTranslations('common');
