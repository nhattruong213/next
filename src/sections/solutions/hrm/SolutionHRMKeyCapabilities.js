...
const COLORS = ['primary', 'secondary', 'secondary', 'success', 'warning', 'success'];

// ----------------------------------------------------------------------

export default function SolutionHRMKeyCapabilities() {
  const t = useTranslations('solutions.hrm.key_capabilities');
  const SERVICES = [
    {
      name: t('recruiting_management'),
    ...
    {
      name: t('training_development'),
      icon: '/assets/icons/ic_search.svg',
    },
    {
      name: t('performance_management'),
