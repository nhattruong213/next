...
const COLORS = ['primary', 'secondary', 'success', 'success', 'warning', 'success'];

// ----------------------------------------------------------------------

export default function SolutionRoboticKeyCapabilities() {
  const t = useTranslations('solutions.robotic.key_capabilities');
  const SERVICES = [
    {
      name: t('automated_Workflow_execution.name'),
      icon: '/assets/icons/ic_sketch_design.svg',
    },
    {
      name: t('data_extraction_and_manipulation.name'),
      icon: '/assets/icons/ic_search.svg',
    },
    {
      name: t('integration_with_existing_systems.name'),
