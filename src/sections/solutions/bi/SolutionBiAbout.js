...
export default function SolutionBiAbout() {
  const t = useTranslations('solutions.business_intelligence.bi_about');
  const SUMMARY = [
    {
      title: t('overload.title'),
      number: 14000,
    ...
    >
      ...
      >
        <Grid xs={12} md={6} lg={6}>
          <Image
            alt="about"
            src="/assets/images/solutions/solution-bi-about.png"
            ratio="3/4"
            sx={{ borderRadius: 2 }}
          />
        </Grid>
