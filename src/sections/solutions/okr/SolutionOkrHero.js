...
export default function SolutionOkrHero() {
  const theme = useTheme();
  const t = useTranslations('solutions.okr_performance_management');
    ...
    <Box
      sx={{
        ...bgGradient({
          ...
          imgUrl: '/assets/images/solutions/solution-okr-hero.png',
