...
import SolutionProductionHero from '../SolutionProductionHero';
import SolutionProductionOverView from '../SolutionProductionOverView';
import SolutionProductionKeyCapabilities from '../SolutionProductionKeyCapabilities';
import SolutionProductionBenefits from '../SolutionProductionBenefits';
import SolutionProductionAbout from '../SolutionProductionAbout';
...
export default function SolutionProductionView() {
  ...
  return (
    <>
      <SolutionProductionHero />

      <SolutionProductionOverView />

      <SolutionProductionAbout />

      <SolutionProductionKeyCapabilities />

      <SolutionProductionBenefits />
