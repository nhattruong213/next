...
export default function SolutionProductionBenefits() {
  const mdUp = useResponsive('up', 'md');
  const t = useTranslations('solutions.production_management.benefits');
  const BENEFITS = [
    {
      title: t('enhanced_efficiency.title'),
      description: t('enhanced_efficiency.description'),
      iconColor: 'primary',
    },
    {
      title: t('quality_assurance.title'),
      description: t('quality_assurance.description'),
      iconColor: 'success',
    },
    {
      title: t('cost_reduction.title'),
      description: t('cost_reduction.description'),
      iconColor: 'success',
    },
    {
