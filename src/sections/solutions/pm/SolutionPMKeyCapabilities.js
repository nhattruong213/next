...
export default function SolutionPMKeyCapabilities() {
  const t = useTranslations('solutions.project_management.key_capabilities');
  const SERVICES = [
    {
      name: t('issue_tracking_logging.name'),
      icon: '/assets/icons/ic_sketch_design.svg',
    },
    {
      name: t('documentation_attachments.name'),
      icon: '/assets/icons/ic_search.svg',
    },
    {
      name: t('workflow_approval_processes.name'),
