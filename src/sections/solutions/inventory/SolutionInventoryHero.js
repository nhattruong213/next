...
export default function SolutionInventoryHero() {
  const theme = useTheme();
  const t = useTranslations('solutions.inventory_management');
    ...
    <Box
      sx={{
        ...bgGradient({
          ...
          imgUrl: '/assets/images/solutions/solution-inventory-hero.jpg',
