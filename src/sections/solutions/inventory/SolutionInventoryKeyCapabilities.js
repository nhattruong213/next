...
export default function SolutionInventoryKeyCapabilities() {
  const t = useTranslations('solutions.inventory_management.key_capabilities');
  const SERVICES = [
    {
      name: t('warehouse_management.name'),
      icon: '/assets/icons/ic_sketch_design.svg',
    },
    {
      name: t('inventory_control.name'),
      icon: '/assets/icons/ic_search.svg',
    },
    {
      name: t('inventory_reporting.name'),
